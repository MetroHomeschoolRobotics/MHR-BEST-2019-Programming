...
#pragma config(Sensor, dgtl1,  autoDone,       sensorTouch)
...
//version details
/*
IR to run when pressed not held.
*/
...
int thresh = 2;
int irReturns = 700; //900 was working
int irRun = 0;
